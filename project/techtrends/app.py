...
def post(post_id):
    ...
    if post is None:
      app.logger.info(f'Non-existing article is being retrieved : {post}')
      return render_template('404.html'), 404
    else:
      app.logger.info(f'Article retrieved : {post["title"]}')
...
def healthz():
    ...
    app.logger.info('Health page retrieved successfull')
    return response
